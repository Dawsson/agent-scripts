---
summary: Timeline of changes to agent-scripts.
---
...
- Adapted remaining docs for Claude Code + Bun workflow.
- Added agent-tmux-cli.md spec for future tmux session manager.
